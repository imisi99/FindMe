...
type GDB interface {
	...
	VerifyUser(user *model.User, username, password string) error
	...
	FetchUserPosts(user *model.Post, uid uint) error
...
func (db *GormDB) FetchUserPosts(user *model.Post, uid uint) error {
