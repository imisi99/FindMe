...
func SetupHandler(router *gin.Engine, service *Service) {
	...
	protectedPostRoutes.DELETE("/remove-post", service.RemoveSavedPost)
	protectedPostRoutes.PUT("/edit", service.EditPost)
	protectedPostRoutes.PATCH("/edit-view", service.EditPostView)
